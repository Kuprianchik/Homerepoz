...
namespace Симулятор_компьютерного_клуба
{
    ...
    class ComputerClub
    {
        ...
        public ComputerClub(int computersCounts)
        {
            Random random = new Random();
            for (int i = 0; i < computersCounts; i++)
            {
        ...
        public void CreateNewClients(int count, Random random)
        {
            ...
            {
                _clients.Enqueue(new Client(random.Next(100, 350), random));
            }
        }
        public void work()
        {
                ...
                if (int.TryParse(userInput, out int computerNumber))
                {
                    ...
                    if(computerNumber>=0 && computerNumber< _computers.Count)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("Денег у клиента не хватило. Он разозлился и ушёл.");
                            }
                        }
                    }
                    else
    ...
    class Client
    {
        ...
        {
            _money = money;
            DesiredMinutes = random.Next(5, 20);
        }
